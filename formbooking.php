...
<body>
  <div class="container mx-auto mt-8">
    <h1 class="text-2xl font-bold">Form Booking AA 203</h1>
    <form action="" method="post">
      <div class="grid grid-cols-1 gap-4">
        <div class="mb-2">
          <label for="nama-dosen" class="text-sm font-medium">Nama Dosen</label>
        ...
        <div class="mb-2">
          <label for="matkul" class="text-sm font-medium">Matkul</label>
        ...
        <div class="mb-2">
          <label for="smt" class="text-sm font-medium">Semester</label>
        ...
        <div class="mb-2">
          <label for="waktu" class="text-sm font-medium">Waktu</label>
        ...
        <div class="mb-4">
          <label for="hari" class="text-sm font-medium">Hari</label>
